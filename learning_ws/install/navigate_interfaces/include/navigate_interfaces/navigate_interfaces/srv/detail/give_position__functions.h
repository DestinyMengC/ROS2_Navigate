...
#ifndef NAVIGATE_INTERFACES__SRV__DETAIL__GIVE_POSITION__FUNCTIONS_H_
#define NAVIGATE_INTERFACES__SRV__DETAIL__GIVE_POSITION__FUNCTIONS_H_
 ...
 * calls
 * navigate_interfaces__srv__GivePosition_Request__init().
...
/**
 * It calls
 * navigate_interfaces__srv__GivePosition_Request__fini()
 ...
 * navigate_interfaces__srv__GivePosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * navigate_interfaces__srv__GivePosition_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * navigate_interfaces__srv__GivePosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navigate_interfaces
...
/**
 * It calls
 * navigate_interfaces__srv__GivePosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_navigate_interfaces
...
/**
 * It allocates the memory for the array and calls
 * navigate_interfaces__srv__GivePosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_navigate_interfaces
...
/**
 * It calls
 * navigate_interfaces__srv__GivePosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAVIGATE_INTERFACES__SRV__DETAIL__GIVE_POSITION__FUNCTIONS_H_
