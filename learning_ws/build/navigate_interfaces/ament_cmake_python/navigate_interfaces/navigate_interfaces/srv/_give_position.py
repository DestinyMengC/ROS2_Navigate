...
class Metaclass_GivePosition_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('navigate_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GivePosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'navigate_interfaces.srv.GivePosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from navigate_interfaces.srv import _give_position
...
class GivePosition(metaclass=Metaclass_GivePosition):
    from navigate_interfaces.srv._give_position import GivePosition_Request as Request
    from navigate_interfaces.srv._give_position import GivePosition_Response as Response
