...
#include "navigate_interfaces/srv/detail/give_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const navigate_interfaces::srv::GivePosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  navigate_interfaces::srv::GivePosition_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const navigate_interfaces::srv::GivePosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigate_interfaces::srv::GivePosition_Request *>(
    untyped_ros_message);
...
{
  return &navigate_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigate_interfaces, srv, GivePosition_Request)() {
  return &navigate_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_navigate_interfaces
cdr_serialize(
  const navigate_interfaces::srv::GivePosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: finish
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  navigate_interfaces::srv::GivePosition_Response & ros_message)
{
  // Member: finish
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const navigate_interfaces::srv::GivePosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<navigate_interfaces::srv::GivePosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &navigate_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigate_interfaces, srv, GivePosition_Response)() {
  return &navigate_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Response__handle;
}
...
{
  return &navigate_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigate_interfaces, srv, GivePosition)() {
  return &navigate_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition__handle;
}
