...
#include "navigate_interfaces/srv/detail/give_position__rosidl_typesupport_fastrtps_c.h"
...
using _GivePosition_Request__ros_msg_type = navigate_interfaces__srv__GivePosition_Request;
...
size_t get_serialized_size_navigate_interfaces__srv__GivePosition_Request(
  const void * untyped_ros_message,
...
static uint32_t _GivePosition_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_navigate_interfaces__srv__GivePosition_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_navigate_interfaces
size_t max_serialized_size_navigate_interfaces__srv__GivePosition_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GivePosition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_navigate_interfaces__srv__GivePosition_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigate_interfaces, srv, GivePosition_Request)() {
...
using _GivePosition_Response__ros_msg_type = navigate_interfaces__srv__GivePosition_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_navigate_interfaces
size_t get_serialized_size_navigate_interfaces__srv__GivePosition_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GivePosition_Response__ros_msg_type * ros_message = static_cast<const _GivePosition_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_navigate_interfaces__srv__GivePosition_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_navigate_interfaces
size_t max_serialized_size_navigate_interfaces__srv__GivePosition_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _GivePosition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_navigate_interfaces__srv__GivePosition_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigate_interfaces, srv, GivePosition_Response)() {
...
// already included above
// #include "navigate_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "navigate_interfaces/srv/give_position.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigate_interfaces, srv, GivePosition)() {
