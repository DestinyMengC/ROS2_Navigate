...
static const _GivePosition_Request_type_support_symbol_names_t _GivePosition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigate_interfaces, srv, GivePosition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, navigate_interfaces, srv, GivePosition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, navigate_interfaces, srv, GivePosition_Request)() {
  return &::navigate_interfaces::srv::rosidl_typesupport_c::GivePosition_Request_message_type_support_handle;
}
...
static const _GivePosition_Response_type_support_symbol_names_t _GivePosition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigate_interfaces, srv, GivePosition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, navigate_interfaces, srv, GivePosition_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, navigate_interfaces, srv, GivePosition_Response)() {
  return &::navigate_interfaces::srv::rosidl_typesupport_c::GivePosition_Response_message_type_support_handle;
}
...
static const _GivePosition_type_support_symbol_names_t _GivePosition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, navigate_interfaces, srv, GivePosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, navigate_interfaces, srv, GivePosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, navigate_interfaces, srv, GivePosition)() {
  return &::navigate_interfaces::srv::rosidl_typesupport_c::GivePosition_service_type_support_handle;
}
